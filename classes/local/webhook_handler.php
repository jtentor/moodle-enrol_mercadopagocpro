...
use enrol_mercadopagocpro\event\webhook_received;
use enrol_mercadopagocpro\event\webhook_rejected;
...
class webhook_handler
{
     ...
     */
    public const LOG_TABLE = 'enrol_mercadopagocpro_wh';
    ...
    protected function verify_signature(array $headers, array &$notification, credentials $credentials): string
    {
        ...
        $tolerance = (int)get_config('enrol_mercadopagocpro', 'signaturetolerance');
    ...
    {
        $value = get_config('enrol_mercadopagocpro', 'requiresignature');
    ...
    {
        return (bool)get_config('enrol_mercadopagocpro', 'deferwebhooks');
    }
    ...
    protected function resolve_instance(array $query): ?\stdClass
    {
        ...
        $instance = $DB->get_record('enrol', ['id' => $enrolid, 'enrol' => 'mercadopagocpro']);
    ...
    protected function is_duplicate(array $notification): bool
    {
        ...
        try {
            $cache = \cache::make('enrol_mercadopagocpro', 'webhookdedupe');
