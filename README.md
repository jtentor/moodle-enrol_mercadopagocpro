...
During the development and documentation of this project, the large languages models Claude Opus 5 (Anthropic, 2026), ChatGPT GPT-5.6 Sol (OpenAI, 2026), and GitHub Copilot (Microsoft, 2026) and Gemini 3.1 pro (Google 2026), was utilized.
