...
class MPRequest
{
    ...
    {
        return $this->retry_on; 
    }
    public function setRetryOn(?array $v): void
    {
        $this->retry_on = $v; 
    }
    ...
    public function getJitter(): ?bool
    {
        return $this->jitter; 
    }
    public function setJitter(?bool $v): void
    {
        $this->jitter = $v; 
    }

    public function getOnRetry()
    {
        return $this->on_retry; 
    }
    public function setOnRetry($v): void
    {
        $this->on_retry = $v; 
    }
}
