...
Feature: Mercado Pago Checkout Pro enrolment method
  ...
  Background:
    ...
    And the following config values are set as admin:
      | accesstoken    | TEST-ACCESS-TOKEN    | enrol_mpcheckoutpro |
      | webhooksecret  | TEST-WEBHOOK-SECRET  | enrol_mpcheckoutpro |
      | currency       | ARS                  | enrol_mpcheckoutpro |
